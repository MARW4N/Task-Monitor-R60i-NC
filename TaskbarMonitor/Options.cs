...
{    
    public class Options
    {
        ...
        public SoundcoreOptions Soundcore { get; set; } = new SoundcoreOptions();
        ...
        public void CopyTo(Options opt)
        {
            ...
            if (this.Soundcore != null)
            {
                opt.Soundcore = new SoundcoreOptions
                {
                    ExePath = this.Soundcore.ExePath,
                    MacAddress = this.Soundcore.MacAddress,
                    PollIntervalSeconds = this.Soundcore.PollIntervalSeconds,
                    HideWhenDisconnected = this.Soundcore.HideWhenDisconnected,
                    LowBatteryThreshold = this.Soundcore.LowBatteryThreshold,
            ...
            if (this.MonitorOptions == null)
                this.MonitorOptions = new Dictionary<string, MonitorOptions>();
